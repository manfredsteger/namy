...
export const de: Translations = {
  ...
  remotes: {
    ...
    cloneBtn: 'Remote klonen',
    copySuffix: '{{name}} (Kopie)',
    cloneHint: 'Zugangsdaten wurden vom Original übernommen. Ändern Sie nur, was abweicht — z.B. Anzeigename, Medientyp und Basis-Pfad.',
    passwordInherited: '(Leer lassen – Passwort wird vom Original übernommen)',
    credentialsInherited: 'Passwort wird vom Original übernommen',
